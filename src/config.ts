export const SITE = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Public edge for my self-hosted services — self-hosted NetBird mesh with Traefik, Cloudflare tunnels for public apps, exit node and peer relay for the private mesh, TLS via Let's Encrypt.",
      tech: ["NetBird", "Traefik", "Cloudflare Tunnel"],
      link: "https://netbird.debnerd.in",
    },
    {
      title: "Vaultwarden",
      description: "Self-hosted password manager served over a Cloudflare tunnel — my Bitwarden-compatible vault with encrypted off-site backups.",
      tech: ["Vaultwarden", "SQLite", "Docker"],
      link: "https://vault.debnerd.in",
    },
    {
    ...
    {
      title: "IT-Tools",
      description: "A collection of handy developer utilities — encoders, converters, generators — self-hosted over a Cloudflare tunnel.",
      tech: ["Docker", "Vue.js"],
    ...
    {
      title: "Immich",
      description: "Self-hosted photo backup behind local Traefik with wildcard TLS — terabytes of photos and growing, reachable only over my NetBird mesh.",
      tech: ["Docker Compose", "PostgreSQL", "NetBird", "Traefik"],
      link: "https://blog.debnerd.in",
    },
    {
      title: "This Website",
